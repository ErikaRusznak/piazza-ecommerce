...
const ReviewComponent = ({reviewId, firstName, lastName, email, imageName, rating, description, publishDate, updateReviewInState}) => {
        ...
        <div>
            <div className="flex flex-col gap-4  mb-2 border rounded-2xl shadow-md dark:border-indigo-300">
               ...
               <div className="flex justify-between pt-1.5 ">
                   ...
                   {((isAuthenticated && userRole==="CLIENT") && email===username) && (
                       <div className="mr-5">
